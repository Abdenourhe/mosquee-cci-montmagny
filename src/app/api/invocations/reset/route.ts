...
const INVOCATIONS = [
  // ═══════════════════════════════════════════════════════════
  // CATÉGORIE : DAILY (Invocations du jour) — 20 invocations
  // ═══════════════════════════════════════════════════════════
  ...
  // ── Côté GAUCHE ──
  {
    ...
    side: "left", order: 1, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 2, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 3, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 4, category: "daily", active: true,
  },
  {
    label: "Après manger",
    ...
    side: "left", order: 5, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 6, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 7, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 8, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 9, category: "daily", active: true,
  },
  {
    label: "Pour la santé",
    ...
    side: "left", order: 10, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 11, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 12, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 13, category: "daily", active: true,
  },
  {
    ...
    side: "left", order: 14, category: "daily", active: true,
  },
  {
    label: "Kafarat al-Majlis",
    arabic: "سُبْحَانَكَ اللَّهُمَّ وَبِحَمْدِكَ أَشْهَدُ أَنْ لاَ إِلَهَ إِلَّا أَنْتَ أَسْتَغْفِرُكَ وَأَتُوبُ إِلَيْكَ",
    ...
    side: "left", order: 15, category: "daily", active: true,
  },
  ...
  // ── Côté DROITE ──
  {
    ...
    side: "right", order: 1, category: "daily", active: true,
  },
  {
  ...
  },
  {
    ...
    side: "right", order: 5, category: "daily", active: true,
  },

  // ═══════════════════════════════════════════════════════════
  // CATÉGORIE : RAMADAN — 10 invocations
  // ═══════════════════════════════════════════════════════════
  {
    ...
    side: "left", order: 1, category: "ramadan", active: true,
  },
  {
  ...
  },
  {
    ...
    side: "right", order: 1, category: "ramadan", active: true,
  },
  {
    ...
    side: "right", order: 2, category: "ramadan", active: true,
  },
  {
    ...
    side: "left", order: 4, category: "ramadan", active: true,
  },
  {
    ...
    side: "right", order: 3, category: "ramadan", active: true,
  },
  {
    ...
    side: "left", order: 5, category: "ramadan", active: true,
  },
  {
    ...
    side: "right", order: 4, category: "ramadan", active: true,
  },
  {
    ...
    side: "left", order: 6, category: "ramadan", active: true,
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    side: "left", order: 1, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "left", order: 2, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "left", order: 3, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "left", order: 4, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "right", order: 1, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "right", order: 2, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "right", order: 3, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "right", order: 4, category: "eid_fitr", active: true,
  },
  {
    label: "Pour les défunts",
    arabic: "اللَّهُمَّ اغْفِرْ لِلْمُؤْمِنِينَ وَالْمُؤْمِنَاتِ الأَحْيَاءِ مِنْهُمْ وَالأَمْوَاتِ",
    french: "Ô Allah, pardonne aux croyants et croyantes, parmi eux les vivants et les morts.",
    side: "left", order: 5, category: "eid_fitr", active: true,
  },
  {
    label: "Pour la protection",
    arabic: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ",
    french: "Je cherche refuge dans les paroles parfaites d'Allah contre le mal de ce qu'Il a créé.",
    side: "right", order: 5, category: "eid_fitr", active: true,
  },
  {
    ...
    side: "left", order: 6, category: "eid_fitr", active: true,
  },
  {
    label: "Salat al-Eid",
    ...
    side: "right", order: 6, category: "eid_fitr", active: true,
  },

  // ═══════════════════════════════════════════════════════════
  // CATÉGORIE : EID_EL_ADHA — 15 invocations
  // ═══════════════════════════════════════════════════════════
  {
    label: "Takbirat al-Eid al-Adha",
    arabic: "اللَّهُ أَكْبَرُ اللَّهُ أَكْبَرُ اللَّهُ أَكْبَرُ لاَ إِلَهَ إِلَّا اللَّهُ وَاللَّهُ أَكْبَرُ اللَّهُ أَكْبَرُ وَلِلَّهِ الْحَمْدُ",
    french: "Allah est le plus Grand (3x). Il n'y a de divinité qu'Allah. Allah est le plus Grand (2x). Et à Allah toute louange.",
    side: "left", order: 1, category: "eid_adha", active: true,
  },
  {
    label: "Invocation du sacrifice",
    arabic: "إِنَّ صَلَاتِي وَنُسُكِي وَمَحْيَايَ وَمَمَاتِي لِلَّهِ رَبِّ الْعَالَمِينَ لاَ شَرِيكَ لَهُ وَبِذَلِكَ أُمِرْتُ وَأَنَا أَوَّلُ الْمُسْلِمِينَ",
    french: "Ma prière, mon sacrifice, ma vie et ma mort sont pour Allah, Seigneur de l'univers. Il n'a pas d'associé, et c'est là ce qui m'a été commandé, et je suis le premier des musulmans.",
    side: "left", order: 2, category: "eid_adha", active: true,
  },
  {
    label: "Dou'â avant le sacrifice",
    arabic: "بِسْمِ اللَّهِ وَاللَّهُ أَكْبَرُ",
    french: "Au nom d'Allah, et Allah est le plus Grand.",
    side: "left", order: 3, category: "eid_adha", active: true,
  },
  {
    label: "Dou'â pour l'acceptation du sacrifice",
    arabic: "اللَّهُمَّ تَقَبَّلْ مِنَّا كَمَا تَقَبَّلْتَ مِنْ خَلِيلِكَ إِبْرَاهِيمَ عَلَيْهِ السَّلاَمُ",
    french: "Ô Allah, accepte de nous comme Tu as accepté de Ton ami Ibrahim, paix sur lui.",
    side: "left", order: 4, category: "eid_adha", active: true,
  },
  {
    label: "Pour la famille et les proches",
    arabic: "اللَّهُمَّ بَارِكْ لَنَا فِي أَهْلِنَا وَذُرِّيَّاتِنَا وَاجْعَلْنَا لِلْمُتَّقِينَ إِمَامًا",
    french: "Ô Allah, bénis nos familles et nos descendants, et fais-nous des modèles pour les pieux.",
    side: "left", order: 5, category: "eid_adha", active: true,
  },
  {
    label: "Pour les voyageurs du Hajj",
    arabic: "اللَّهُمَّ ارْزُقْنَا حَجَّ بَيْتِكَ الْحَرَامِ وَزِيَارَةَ قَبْرِ نَبِيِّكَ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ",
    french: "Ô Allah, accorde-nous le pèlerinage de Ta Maison Sacrée et la visite du tombeau de Ton Prophète.",
    side: "right", order: 1, category: "eid_adha", active: true,
  },
  {
    label: "Pour les nécessiteux",
    arabic: "اللَّهُمَّ أَعْطِ كُلَّ مَنْ سَأَلَنَا مِنْ فَضْلِكَ وَلاَ تَرُدَّ يَدَ سَائِلٍ خَائِبَةً",
    french: "Ô Allah, donne à tous ceux qui nous demandent de Ta générosité, et ne laisse pas la main d'un mendiant revenir vide.",
    side: "right", order: 2, category: "eid_adha", active: true,
  },
  {
    label: "Pour la communauté musulmane",
    arabic: "اللَّهُمَّ أَجْمَعْنَا وَأَجْمَعْ شَمْلَنَا وَأَصْلِحْ ذَاتَ بَيْنِنَا",
    french: "Ô Allah, rassemble-nous, réunis notre communauté, et réconcilie-nous entre nous.",
    side: "right", order: 3, category: "eid_adha", active: true,
  },
  {
    label: "Pour la santé et la prospérité",
    arabic: "اللَّهُمَّ إِنَّا نَسْأَلُكَ عِلْمًا نَافِعًا وَرِزْقًا طَيِّبًا وَعَمَلًا مُتَقَبَّلًا",
    french: "Ô Allah, nous Te demandons un savoir bénéfique, une subsistance pure et une œuvre acceptée.",
    side: "right", order: 4, category: "eid_adha", active: true,
  },
  {
    label: "Pour les défunts",
    arabic: "اللَّهُمَّ اغْفِرْ لِلْمُؤْمِنِينَ وَالْمُؤْمِنَاتِ الأَحْيَاءِ مِنْهُمْ وَالأَمْوَاتِ",
    french: "Ô Allah, pardonne aux croyants et croyantes, parmi eux les vivants et les morts.",
    side: "left", order: 6, category: "eid_adha", active: true,
  },
  {
    label: "Pour la protection",
    arabic: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ",
    french: "Je cherche refuge dans les paroles parfaites d'Allah contre le mal de ce qu'Il a créé.",
    side: "right", order: 5, category: "eid_adha", active: true,
  },
  {
    label: "Pour l'unité de la Oumma",
    arabic: "وَاعْتَصِمُواْ بِحَبْلِ اللَّهِ جَمِيعًا وَلاَ تَفَرَّقُواْ",
    french: "Et cramponnez-vous tous ensemble à la corde d'Allah, et ne vous divisez pas.",
    side: "left", order: 7, category: "eid_adha", active: true,
  },
  {
    label: "Salat al-Eid al-Adha",
    arabic: "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ كَمَا صَلَّيْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ",
    french: "Ô Allah, bénis Muhammad et la famille de Muhammad, comme Tu as béni Ibrahim et la famille d'Ibrahim.",
    side: "right", order: 6, category: "eid_adha", active: true,
  },
  {
    label: "Dou'â de gratitude",
    arabic: "اللَّهُمَّ تَقَبَّلْ مِنَّا صِيَامَنَا وَقِيَامَنَا وَرُكُوعَنَا وَسُجُودَنَا",
    french: "Ô Allah, accepte de nous notre jeûne, notre prière nocturne, nos prosternations et nos génuflexions.",
    side: "right", order: 7, category: "eid_adha", active: true,
  },
  {
    label: "Pour la paix mondiale",
    arabic: "اللَّهُمَّ اجْعَلْ هَذَا الْبَلَدَ آمِنًا وَارْزُقْ أَهْلَهُ مِنَ الثَّمَرَاتِ",
    french: "Ô Allah, rends ce pays sûr et accorde à ses habitants des fruits de toute sorte.",
    side: "right", order: 8, category: "eid_adha", active: true,
  },

  // ═══════════════════════════════════════════════════════════
  // CATÉGORIE : ASHOURA — 12 invocations
  // ═══════════════════════════════════════════════════════════
  {
    ...
    side: "left", order: 1, category: "ashoura", active: true,
  },
  {
    ...
    side: "left", order: 2, category: "ashoura", active: true,
  },
  {
    ...
    side: "left", order: 3, category: "ashoura", active: true,
  },
  {
    ...
    side: "left", order: 4, category: "ashoura", active: true,
  },
  {
    ...
    side: "left", order: 5, category: "ashoura", active: true,
  },
  {
    ...
    side: "right", order: 1, category: "ashoura", active: true,
  },
  {
    ...
    side: "right", order: 2, category: "ashoura", active: true,
  },
  {
    ...
    side: "right", order: 3, category: "ashoura", active: true,
  },
  {
    label: "Pour la famille et les proches",
    ...
    side: "right", order: 4, category: "ashoura", active: true,
  },
  {
    ...
    side: "right", order: 5, category: "ashoura", active: true,
  },
  {
    label: "Pour l'unité de la Oumma",
    arabic: "وَاعْتَصِمُواْ بِحَبْلِ اللَّهِ جَمِيعًا وَلاَ تَفَرَّقُواْ",
    french: "Et cramponnez-vous tous ensemble à la corde d'Allah, et ne vous divisez pas.",
    side: "left", order: 6, category: "ashoura", active: true,
  },
  {
    label: "Pour la protection",
    arabic: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ",
    french: "Je cherche refuge dans les paroles parfaites d'Allah contre le mal de ce qu'Il a créé.",
    side: "right", order: 6, category: "ashoura", active: true,
  },
];
  ...
  try {
    ...
    return NextResponse.json({
      ...
      categories: {
        ...
        eid_fitr: INVOCATIONS.filter(i => i.category === "eid_fitr").length,
        eid_adha: INVOCATIONS.filter(i => i.category === "eid_adha").length,
