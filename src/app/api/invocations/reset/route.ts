...
const INVOCATIONS = [
  // ── GAUCHE : Général ──
  {
    ...
    side: "left", order: 1, group: "general",
  },
  {
  ...
  },
  {
    ...
    side: "left", order: 6, group: "voyage",
  },
  {
    ...
    side: "left", order: 7, group: "voyage",
  },
  {
    ...
    side: "left", order: 8, group: "protection",
  },
  {
    ...
    side: "left", order: 9, group: "repentance",
  },
  {
    label: "Pour la santé",
    ...
    side: "left", order: 10, group: "sante",
  },
  {
    ...
    side: "left", order: 11, group: "guidance",
  },
  {
    ...
    side: "left", order: 12, group: "famille",
  },
  {
    ...
    side: "left", order: 13, group: "general",
  },
  {
  ...
  },
  {
    ...
    side: "left", order: 15, group: "repentance",
  },
  ...
  // ── DROITE : Général ──
  {
    ...
    side: "right", order: 1, group: "general",
  },
  {
  ...
  },
  {
    ...
    side: "right", order: 9, group: "repentance",
  },
  {
    ...
    side: "right", order: 10, group: "general",
  },
  {
    ...
    side: "right", order: 11, group: "salat",
  },
  {
    ...
    side: "right", order: 12, group: "sante",
  },
  {
    label: "Dua al-Qunoot",
    ...
    side: "right", order: 13, group: "guidance",
  },
  {
    ...
    side: "right", order: 14, group: "maison",
  },
  {
    ...
    side: "right", order: 15, group: "repentance",
  },
];
...
export async function POST() {
  try {
    ...
    const created = await prisma.invocation.createMany({
      data: INVOCATIONS.map((inv) => ({ ...inv, active: true, category: "daily" })),
    });
